...
const WORKS = [
  {
    ...
    summary: '全校最耀眼的高冷校草，被一个「系统」按着头，往社死路上推。',
    synopsis:
      '顾言澈，全校公认的高冷校草，本该平静地度过高中三年 —— 直到某天，一个莫名其妙的「系统」绑定了他。' +
      '\n\n' +
      '「叮！今日社死任务发布。」' +
      '\n\n' +
      '食堂里大喊"阿姨多打点肉，我还在长身体"、图书馆里唱《小苹果》、体育课上扮演海贼王…… 一个拼命想维持体面的人，偏偏被命运按着头往社死路上推。而这一切，总被同班的林小满看在眼里。' +
      '\n\n' +
      '本作共 4 集，每集约 1 分 30 秒。用 AI 生成画面，逐帧打磨分镜。',
    tags: ['校园', '恋爱喜剧', '系统', 'AI生成'],
    episodes: [
      {
        ep: 1,
        title: '第一集 · 食堂社死・系统降临',
      ...
      },
      {
        ep: 3,
        title: '第三集 · 体育课社死・海贼王',
        file: 'videos/xiaocao/ep03.mp4',
        duration: '1:36',
      },
      {
        ep: 4,
        title: '第四集 · 打嗝失控・全校直播',
        file: 'videos/xiaocao/ep04.mp4',
        duration: '1:30',
      },
    ],
  },
